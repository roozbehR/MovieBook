...
export default function AuthenticatedNavBar({userName, profileImagePath}) {
  // if userName and profileImagePath are not passed, set default values
  const passedUserName = userName? userName : "John doe";
  const passedProfileImagePath = profileImagePath? profileImagePath: "https://randomuser.me/api/portraits/men/30.jpg";
