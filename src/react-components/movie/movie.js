...
import { PlusCircleOutlined, MinusCircleOutlined, CheckCircleTwoTone } from "@ant-design/icons"
import "./style.css"
                ...
                <Row>
                    ...
                    <Col xs={14} sm={14} md={16} lg={16} xl={20}>
                        <div className="movie-des">
                            ...
                            <p className="release-date">{this.state.movie.year}
                                <span className="movie-rate"><Rate disabled="true" value={this.state.movie.rating} allowHalf="true" /></span>
                            </p>
                    ...
                    <Col span={24}>
                        <Collapse activeKey={!this.state.reviewButton.enabled} ghost>
                            <Panel key="true" showArrow="false" style={{ width: "100%" }}>
                                <Rate className="review-rate" allowHalf="true" value={this.state.reviewRating} onChange={this.handleReviewRating} />
                                <TextArea className="review-text" onChange={this.handleReviewText} maxLength="250" value={this.state.reviewText}>
                                </TextArea>
                            </Panel>
                        </Collapse>
                    </Col>
                ...
                <Row>
                    <Col span={24}>
                        {this.state.reviews.map(review =>
                            <Review showComments="true" addCommentEnabled="true" review={review} />
                        )}
                    </Col>
                </Row>
            </Card>
