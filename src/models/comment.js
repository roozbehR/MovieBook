...
let Comments = [
    new Comment(1, getRandomReview(), getRandomUser(), 'Blah blah a b c okay blah!'),
    new Comment(2, getRandomReview(), getRandomUser(), 'Totally agree!'),
    new Comment(3, getRandomReview(), getRandomUser(), 'Lorem ipsum never ends, keep it up!'),
    new Comment(4, getRandomReview(), getRandomUser(), 'The plot twist blew my mind, I totally agree!'),
