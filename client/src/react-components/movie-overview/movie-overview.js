...
export default function MovieOverview ({sectionTitle, imgURL, movieTitle, screeningYear, plot}){
    return (
        <div>
          {sectionTitle && (
              <Card title={sectionTitle} className="random-movie-card">
                <CardContents imgURL={imgURL} movieTitle={movieTitle} screeningYear={screeningYear} plot={plot} />
              </Card>
          )}
          {!sectionTitle &&
...
function CardContents ({imgURL, movieTitle, screeningYear, plot}){
  return (
      <Row>
